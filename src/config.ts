...
export const siteConfig: SiteConfig = {
	title: "Raiton",
	subtitle: "Teenager and his daily life",
	...
	banner: {
		enable: true,
		src: "assets/images/minimal-banner.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
